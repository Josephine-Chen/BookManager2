...
class BookTest < ActiveSupport::TestCase
  ...
  context "With a proper context, " do
    ...
    should "allow for a published date in the past after the contract date" do
      ...
      big_ruby_book = FactoryGirl.build(:book, published_date: 9.month.ago, category: @ruby, title: "The Big Book of Ruby")
      assert big_ruby_book.valid? 
    end
    
    should "allow for just the published date to be nil" do
      big_ruby_book = FactoryGirl.build(:book, published_date: nil, category: @ruby, title: "The Big Book of Ruby")
      assert big_ruby_book.valid? 
    end
    
    should "not allow for a published date in the past before the contract date" do
      big_ruby_book = FactoryGirl.build(:book, published_date: 11.month.ago, category: @ruby, title: "The Big Book of Ruby")
      deny big_ruby_book.valid? 
    end
    
    should "not allow for a published date in the future" do
      big_ruby_book = FactoryGirl.build(:book, published_date: 1.month.from_now, category: @ruby, title: "The Big Book of Ruby")
      deny big_ruby_book.valid? 
    end
